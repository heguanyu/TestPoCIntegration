...
install_xcframework "${PODS_ROOT}/TestGithubCI/Core-0.2.3/Core.xcframework" "TestGithubCI" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/TestGithubCI/TestXCFramework-0.2.3/TestXCFramework.xcframework" "TestGithubCI" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/TestGithubCI/MLFoundations-0.2.3/MLFoundations.xcframework" "TestGithubCI" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
